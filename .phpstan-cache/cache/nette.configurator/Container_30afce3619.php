...
class Container_30afce3619 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_30afce3619 $container)
			{
	...
	public function createServiceContainer(): Container_30afce3619
	{
		return $this;
	}
