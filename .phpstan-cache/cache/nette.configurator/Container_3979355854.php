...
// source: phar:///home/luis/code-challenge-master/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_3979355854 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3979355854 $container)
			{
	...
	public function createServiceContainer(): Container_3979355854
	{
		return $this;
	}
