...
class Container_7e1c4d2c69 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7e1c4d2c69 $container)
			{
	...
	public function createServiceContainer(): Container_7e1c4d2c69
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'TERM_PROGRAM' => 'vscode',
				'VSCODE_IPC_HOOK_CLI' => '/run/user/1000/vscode-ipc-746ce4dd-45ec-4d34-92fb-d4110ada6c71.sock',
