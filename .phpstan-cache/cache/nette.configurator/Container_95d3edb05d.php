...
class Container_95d3edb05d extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_95d3edb05d $container)
			{
	...
	public function createServiceContainer(): Container_95d3edb05d
	{
		return $this;
	}
