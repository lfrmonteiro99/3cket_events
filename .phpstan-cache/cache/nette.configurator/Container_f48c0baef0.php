<?php
// source: phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_f48c0baef0 extends _PHPStan_ac6dae9b0\Nette\DI\Container
{
	protected $tags = [
	...
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/var/www']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('075'),
			[
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
			],
			['/var/www']
		);
	}
	...
	public function createService062(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f48c0baef0 $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/.phpstan-cache/resultCache.php',
					...
					null,
					[
						'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/var/www/.phpstan-cache/resultCache.php');
	}
	...
	public function createService070(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			['/var/www'],
			[
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
	...
	public function createService077(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/var/www',
			'/var/www/.phpstan-cache',
			['phar:///var/www/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon', '/var/www/phpstan.neon'],
			$this->getParameter('analysedPaths'),
			['/var/www'],
			$this->getParameter('analysedPathsFromConfig'),
			'8',
			'/var/www/phpstan-baseline.neon',
			null,
	...
	public function createService086(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('087'),
			['analyseAndScan' => ['/var/www/vendor', '/var/www/public/index.php'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/var/www');
	}
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/.phpstan-cache/cache/PHPStan');
	}


	public function createServiceContainer(): Container_f48c0baef0
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => ['analyseAndScan' => ['/var/www/vendor', '/var/www/public/index.php'], 'analyse' => []],
			'level' => 8,
			...
			'resultCachePath' => '/var/www/.phpstan-cache/resultCache.php',
			...
			'tmpDir' => '/var/www/.phpstan-cache',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/var/www/.phpstan-cache',
			...
			'generateBaselineFile' => '/var/www/phpstan-baseline.neon',
			'usedLevel' => '8',
